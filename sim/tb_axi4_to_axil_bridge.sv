...
module tb_axi4_to_axil_bridge;
    ...
    feng_ctrl_axi dut_ctrl (
        ...
        .sysref_pl_edge_count(32'd0),
        .sysref_adc_edge_count(32'd0),
        .sysref_dac_edge_count(32'd0),
        .ref_locked(1'b1),
        .error_flags(32'd0),
    ...
    initial begin
        ...
        `TB_CHECK_EQ(rd, 32'h0001_0036, "version via AXI4 bridge Stage 34e candidate")
        ...
        `TB_CHECK_EQ(b0, 32'h0001_0036, "burst beat 0 version Stage 34e candidate")
