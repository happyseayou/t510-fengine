...
def main() -> int:
    ...
    if "--stage27i-100m-spur-taxonomy-audit" not in sys.argv:
        sys.argv.insert(1, "--stage27i-100m-spur-taxonomy-audit")
    ...
    if "--output" not in sys.argv:
        ...
        sys.argv.extend(
            [
                "--output",
                str(root / "reports" / "board" / f"stage27i_100m_spur_taxonomy_audit_external_pps_{date_tag}.json"),
            ]
        )
