...
def main() -> int:
    ...
    if "--stage27i-rfdc-mixer-event-audit" not in sys.argv:
        sys.argv.insert(1, "--stage27i-rfdc-mixer-event-audit")
    ...
    if "--output" not in sys.argv:
        ...
        sys.argv.extend(
            [
                "--output",
                str(root / "reports" / "board" / f"stage27i_rfdc_mixer_event_audit_external_pps_{date_tag}.json"),
            ]
        )
