...
def main() -> int:
    ...
    if "--stage27i-front-end-audit" not in sys.argv:
        sys.argv.insert(1, "--stage27i-front-end-audit")
    ...
    if "--output" not in sys.argv:
        ...
        sys.argv.extend(
            [
                "--output",
                str(root / "reports" / "board" / f"stage27i_frontend_spur_audit_external_pps_{date_tag}.json"),
            ]
        )
