...
PIDFILE="${REPORT_DIR}/stage27h_timing_closure_iter_vivado.pid"
LOG="${REPORT_DIR}/stage27h_timing_closure_iter_vivado.log"
JOU="${REPORT_DIR}/stage27h_timing_closure_iter_vivado.jou"
OUT="${REPORT_DIR}/stage27h_timing_closure_iter_nohup.out"
...
cat <<EOF
Stage 27h timing closure run started.
  pid: ${pid}
  log: ${LOG}
  journal: ${JOU}
  out: ${OUT}
