...
def main() -> int:
    ...
    if "--stage27i-spec-sideband-audit" not in sys.argv:
        sys.argv.insert(1, "--stage27i-spec-sideband-audit")
    ...
    if "--output" not in sys.argv:
        ...
        sys.argv.extend(
            [
                "--output",
                str(root / "reports" / "board" / f"stage27i_spec_sideband_audit_external_pps_{date_tag}.json"),
            ]
        )
