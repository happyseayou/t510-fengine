...
def main() -> int:
    ...
    if "--stage27i-raw-lane-witness-audit" not in sys.argv:
        sys.argv.insert(1, "--stage27i-raw-lane-witness-audit")
    ...
    if "--output" not in sys.argv:
        ...
        sys.argv.extend(
            [
                "--output",
                str(root / "reports" / "board" / f"stage27i_raw_lane_witness_audit_external_pps_{date_tag}.json"),
            ]
        )
