...
```bash
sudo -E /usr/local/share/pynq-venv/bin/python3 scripts/stage29_board_validate.py --bandwidth-mhz 100 --mode time_only
sudo -E /usr/local/share/pynq-venv/bin/python3 scripts/stage29_board_validate.py --bandwidth-mhz 100 --mode spec_only
sudo -E /usr/local/share/pynq-venv/bin/python3 scripts/stage29_board_validate.py --bandwidth-mhz 100 --mode time_spec
sudo -E /usr/local/share/pynq-venv/bin/python3 scripts/stage29_board_validate.py --bandwidth-mhz 200 --mode time_only
sudo -E /usr/local/share/pynq-venv/bin/python3 scripts/stage29_board_validate.py --bandwidth-mhz 200 --mode spec_only
```
